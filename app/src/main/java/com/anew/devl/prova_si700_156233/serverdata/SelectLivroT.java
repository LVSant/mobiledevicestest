package com.anew.devl.prova_si700_156233.serverdata;
...
public class SelectLivro extends AsyncTask<Void, Void, String> {


    private String[] fields;
    private String[] values;

    public SelectLivro(String[] fields, String[] values) {
        ...
        try {
            ...
            String data =
                    URLEncoder.encode("database", "UTF-8") + "=" +
                            ...
                            URLEncoder.encode(Server.TABLE_LIVRO, "UTF-8");
    ...
    protected void onPostExecute(String result) {
        ...
        ArrayList<Livro> categorias = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Livro categoria = new Livro(jsonObject.getLong("_id"), jsonObject.getString("TituloLivro"), jsonObject.getString("Exemplares"));
