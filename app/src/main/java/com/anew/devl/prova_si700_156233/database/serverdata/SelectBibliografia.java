...
public class SelectBibliografia extends AsyncTask<Void, Void, String> {


    private String[] fields;
    private String[] values;

    public SelectBibliografia(String[] fields, String[] values) {
        ...
        try {
            ...
            String data =
                    URLEncoder.encode("database", "UTF-8") + "=" +
                            ...
                            URLEncoder.encode(Server.TABLE_BIBLIOGRAFIA, "UTF-8");
